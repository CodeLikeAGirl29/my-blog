/*! @vimeo/player v2.11.0 | (c) 2024 Vimeo | MIT License | https://github.com/vimeo/player.js */
!(function (e, t) {
  ...
  !(function (e) {
    if (!e.WeakMap) {
      ...
      e.WeakMap =
        (r(t.prototype, "delete", function (e) {
  ...
  function b(n, r) {
    ...
    if ((r = g(r)).event) {
      if ("error" === r.event)
        d(n, r.data.method).forEach(function (e) {
            ...
            value: function (n, e) {
              ...
              return new l(function (e, t) {
                return r
                  .ready()
                  .then(function () {
                    c(r, n, { resolve: e, reject: t }), w(r, n, o);
                  })
                  .catch(t);
              });
            },
              ...
              return new l(function (e, t) {
                return (
                  ...
                  r
                    .ready()
                    .then(function () {
                      c(r, n, { resolve: e, reject: t }), w(r, n);
                    })
                    .catch(t)
                );
              });
            ...
            value: function (n, r) {
              ...
              return new l(function (e, t) {
                ...
                return o
                  .ready()
                  .then(function () {
                    c(o, n, { resolve: e, reject: t }), w(o, n, r);
                  })
                  .catch(t);
              });
            },
